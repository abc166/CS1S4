...
        
            if (!P[j1].done && P[j1].burst_time < P[min].burst_time)
            {
                min = j1;
            }
        
...
        P[current].waiting_time += start - P[current].previous_end_time;

        if (P[current].remaining_burst_time <= time_slice)
        {
            start += P[current].remaining_burst_time;
...
        {
            start += time_slice;
            P[current].previous_end_time = start;
            P[current].remaining_burst_time -= time_slice;
        }
        for (i = current + 1; i < n; i++)
        {
            if (P[i].arrival_time > start)
                break;
